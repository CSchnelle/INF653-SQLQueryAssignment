...
$query = 'SELECT customers.customerID, customers.firstName, customers.lastName, customers.emailAddress, addresses.line1, addresses.city, addresses.state, addresses.zipCode, addresses.phone
